...
function LongTermCare() {
  return (
    <div className="BodyText">
      ...
      <br></br>
      <b>An injury or illness can happen to you at any time. More than one out of every ten people who has received income from their long term care insurance was under age 50 at the time of their claim.</b>
      <p>
        Long Term Care Insurance pays an income benefit if the insured person is dependent and needs someone to assist them with two or more of the activities of daily living (bathing, dressing, feeding, toileting, transferring) or requires supervision because of deteriorating mental ability. A wide variety of illnesses and accidents can cause you to need this kind of care.      </p>
      <br></br>
      <p>
